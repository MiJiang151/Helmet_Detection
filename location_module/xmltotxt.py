...
classes = ['qian']  # 写自己的分类名
pre_dir = r'E:\Drivers\1\yolov5-7.0\datasets\labels\3'  # xml文件所在文件夹
target_dir = r'E:\Drivers\1\yolov5-7.0\datasets\labels\600'  # 想要存储txt文件的文件夹
