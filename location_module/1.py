...
nets = [net_SGD, net_Momentum, net_Adagrad, net_RMSprop, net_Adam, net_Adamax, net_AdamW, net_LBFGS]
optimizers = [opt_SGD, opt_Momentum, opt_Adagrad,  opt_RMSprop, opt_Adam, opt_Adamax, opt_AdamW, opt_LBFGS]
...
# 保存所有loss
losses = [loss_SGD, loss_Momentum, loss_Adagrad,  loss_RMSprop, loss_Adam, loss_Adamax, loss_AdamW,
          loss_LBFGS]
...
# 画图
labels = ['SGD', 'Momentum', 'Adagrad',  'RMSprop', 'Adam', 'Adamax', 'AdamW', 'LBFGS']
